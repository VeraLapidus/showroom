...
class CarInstance(models.Model):
    ...
    price_discount_auto_shows = models.PositiveIntegerField(blank=True, null=True,
                                                            verbose_name='Цена со скидкой ПП, сделка автосалон-покупатель, USD')
    price_discount_producers = models.PositiveIntegerField(blank=True, null=True,
                                                           verbose_name='Цена со скидкой ПП, сделка поставщик-автосалон, USD')
    price_action_auto_shows = models.PositiveIntegerField(blank=True, null=True,
                                                          verbose_name='Цена по акции автосалона, USD')
    price_action_producers = models.PositiveIntegerField(blank=True, null=True,
                                                         verbose_name='Цена по акции поставщика, USD')
